...
Nilai DW setelah dilakukan penanganan adalah $DW = 1.4258$. Hasil ini menunjukkan nilai DW sudah berada dalam selang antara DU \< DW \< 4-DU sehingga sudah tidak ada autokorelasi positif. 
...
berada pada selang daerah tidak ada autokorelasi, yaitu pada rentang DU \< DW \< 4-DU. 
