...
```
Gambar di atas menunjukkan nilai *rounded value* ($\lambda$) optimum sebesar **1,7** dan pada selang kepercayaan 95% nilai memiliki batas bawah **0,95** dan batas atas **2,5**. Selang tersebut memuat nilai satu sehingga dapat dikatakan bahwa data bangkitan stasioner dalam ragam.
...
```
Gambar di atas menunjukkan nilai *rounded value* ($\lambda$) optimum sebesar **2.686869** dan pada selang kepercayaan 95% nilai memiliki batas bawah **-1,03** dan batas atas **5,52**. Selang tersebut memuat nilai satu sehingga dapat dikatakan bahwa data bangkitan stasioner dalam ragam.
...
Gambar di atas menunjukkan nilai *rounded value* ($\lambda$) optimum sebesar **1.878788** dan pada selang kepercayaan 95% nilai memiliki batas bawah **-1,03** dan batas atas **5,52**. Selang tersebut memuat nilai satu sehingga dapat dikatakan bahwa data bangkitan stasioner dalam ragam.